...
<nav class="navbar navbar-inverse">
  <div class="container-fluid ">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li id="loginbtn"><a  href="/login"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
    </ul>
  </div>
</nav>
    ...
    <tr class="template-download fade">
        ...
        <td>
            {% if (file.deleteUrl) { %}
                ...
                <input id="share_url" type="button" class="btn btn-success" value="Share File"><span> <i class="glyphicon glyphicon-share"></i></span </input>
